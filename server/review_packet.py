...
REVIEWER_MODE_INSTRUCTIONS: dict[str, str] = {
    ...
    # requirement.
    "critical": (
        "You are a CRITICAL REVIEWER for a developer who is using Claude Code.\n"
        "Review the work shown in the EVIDENCE section. Be terse and"
        " action-oriented. The user wants to decide their NEXT step quickly.\n"
        "\n"
        ...
        "\n"
        "VERDICT:\n"
        "[choose ONE: Good to proceed | Proceed with caution | Needs fix"
        " before continuing | Stop and investigate]\n"
        "\n"
        "KEY FINDINGS:\n"
        "- [short specific finding 1]\n"
        "- [short specific finding 2]\n"
        "- [short specific finding 3 — at most 3 bullets]\n"
        "\n"
        "MAIN RISK:\n"
        "[one short paragraph naming the single biggest risk]\n"
        "\n"
        ...
        " text. Make it focused, specific, and actionable.]\n"
        "\n"
        "DETAILS:\n"
        "[optional: longer explanation, citations to specific files/lines,"
        " caveats. May be omitted entirely if everything fits above.]"
    ),
    "prompt_coach": (
