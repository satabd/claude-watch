...
REVIEWER_MODE_INSTRUCTIONS: dict[str, str] = {
    "critical": (
        ...
        "Review the work shown in the EVIDENCE section. Reply with these"
        " sections, in order:\n"
        ...
        "  6. NEXT PROMPT FOR CLAUDE CODE: a copy-ready prompt the user can"
        " paste back to Claude Code to address your top concern. Keep this"
        " prompt focused, specific, and actionable.\n"
        "Be terse. Cite specific files / lines from the diff when relevant."
    ),
    "prompt_coach": (
        "You are a PROMPT COACH helping the user write a stronger prompt for"
        " Claude Code based on the current evidence. Reply with these"
        " sections, in order:\n"
        "  1. Clarified intention\n"
        "  2. Stronger prompt structure (bullets)\n"
        "  3. What context to include\n"
        "  4. What context to exclude\n"
        "  5. NEXT PROMPT FOR CLAUDE CODE: the full copy-ready prompt.\n"
